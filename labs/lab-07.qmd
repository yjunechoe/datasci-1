...
Suppose we specify the following model for the primate brains data: $log\_brain\_weight = w_1 \cdot 1 + w_2 \cdot log\_body\_weight$
...
(a) Which of the following is $w_1$ in the model specification $log\_brain\_weight = w_1 \cdot 1 + w_2 \cdot log\_body\_weight$
...
(b) Which of the following is $w_2$ in the model specification $log\_brain\_weight = w_1 \cdot 1 + w_2 \cdot log\_body\_weight$
...
(c) Suppose a primate has a $log\_body\_weight$ equal to 10. Which of the following would the model predict to be the primate's $log\_brain\_weight$? 
...
$\log(brain\_weight\_g) = w_1 \cdot 1 + w_2 \cdot \log(group\_size)$
...
$log\_brain\_weight = w_1 \cdot 1 + w_2 \cdot log\_group\_size$
...
(a) $y = w_11$ `r fitb("test")`
(b) $y = w_11 + w_2x$ `r fitb("test")`
(c) $y = w_11 + w_2z$ `r fitb("test")`
(d) $y = w_11 + w_2x + w_3z$ `r fitb("test")`
(e) $y = w_11 + w_2x + w_3z + w_4a\times{b}$ `r fitb("test")`
(f) $y = w_11 + w_2x + w_3z^2$ `r fitb("test")`
