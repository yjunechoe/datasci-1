...
Model specification: <br>
$y = w_1\mathbf{1} + w_2\mathbf{year}$
...
Model specification: <br>
$y = w_1\mathbf{1} + w_2\mathbf{year} + w_3\mathbf{sex}$
...
Model specification: <br>
$y = w_1\mathbf{1} + w_2\mathbf{year} + w_3\mathbf{sex} + w_4\mathbf{year*sex}$
...
Model specification: <br>
$$
y = w_1\mathbf{1} + w_2\mathbf{year} + w_3\mathbf{sex}+ w_4\mathbf{year\times{sex}} +w_5\mathbf{year}^2
$$
